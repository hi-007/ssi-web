        ...
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          ...
          <div className="max-w-md lg:max-w-lg w-full">
              ...
              <form action="" class=" ">
                ...
                <Link to="/home-eticket">
                  <div className="pt-4">
                    <button class="w-full h-12 shadow-sm rounded-md bg-[#7A66D6] hover:bg-[#7A66FF] transition-all duration-700 text-white text-base font-semibold leading-7">
                      เข้าสู่ระบบ
                    </button>
                  </div>
                </Link>
...
export default LoginPageEticket;
