...
//import "../index.css";
import LogoTicket from "../assets/svg/LogoTicket.svg";
            ...
            <div className="flex h-14 items-center justify-between">
              <div className="md:flex md:items-center md:gap-12">
                <a className="block text-teal-600" href="#">
                  ...
                  <img src={LogoTicket} alt="Logo" className="h-10" />
                </a>
              </div>
                        ...
                        <li>
                          <Link
                            ...
                            className={`inline-block py-2 px-6 text-gray-600 hover:text-gray-800 font-light ${
                              ...
                              ? "bg-[#7A66D6] text-white rounded-full hover:text-white"
            ...
            >
              ...
              <div className="text-body">
                <div className="flex items-center gap-4">
                  <Link to="/profile-eticket">
                    <button
                      type="button"
                      className="py-2.5 px-6 text-sm rounded-full bg-[#7A66D6] text-white cursor-pointer font-light text-center shadow-xs transition-all duration-500 hover:bg-indigo-700"
                    >
                      ดูโปรไฟล์
                    </button>
                  </Link>
